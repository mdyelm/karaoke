...
module.exports.http = {
    ...
    middleware: {
        ...
        extendTimeout: function (req, res, next) {
            req.setTimeout(600 * 1000); // Increase the request timeout to 10 minutes
...
//     bodyParser: require('skipper')({strict: true,maxTimeToBuffer:15000,maxTimeToWaitForFirstFile:15001})
